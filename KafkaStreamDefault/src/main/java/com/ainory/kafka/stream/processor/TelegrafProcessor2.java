...
public class TelegrafProcessor2 extends AbstractProcessor<String, String> {

  private static final Logger logger = LoggerFactory.getLogger(TelegrafProcessor2.class);
